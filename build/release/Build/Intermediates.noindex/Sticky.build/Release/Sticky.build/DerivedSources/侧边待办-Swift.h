...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="侧边待办",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12侧边待办11AppDelegate")
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC12侧边待办16DragHandleNSView")
@interface DragHandleNSView : NSView
...
SWIFT_CLASS("_TtC12侧边待办11PanelWindow")
@interface PanelWindow : NSPanel
...
SWIFT_CLASS("_TtC12侧边待办17ScrollCatcherView")
@interface ScrollCatcherView : NSView
...
SWIFT_CLASS("_TtC12侧边待办12TrackingView")
